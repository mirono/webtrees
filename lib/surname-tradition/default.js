...
// (PatrilinealSurnameTradition etc. — not ported yet). DefaultSurnameTradition
// itself never uses these; confirmed by reading the PHP source, and by the
// grep-for-usage check below being empty within this class's own methods.
