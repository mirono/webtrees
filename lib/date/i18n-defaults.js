...
export const DEFAULT_I18N = {
  ...
  digits: (n) => String(n),
  // I18N::locale()->script()->code() — used by JewishDate to decide
  // whether to render Hebrew numerals instead of plain digits (see
  // docs/php-to-js-migration/task-11-calendar-french-hijri-jalali-jewish.md).
  // 'Latn' matches the default 'en-US' locale's script, confirmed via
